...
function Dashboard({ user }: { user: User }) {
  ...
  return (
    <div className="min-h-screen lg:h-screen bg-gray-100 p-3 sm:p-6 flex flex-col">
      <div className="max-w-7xl mx-auto w-full flex-1 lg:min-h-0 flex flex-col">
        <h1 className="text-2xl font-bold mb-4 flex-shrink-0">
          Welcome, {user.username}!
        </h1>

        <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 sm:gap-6 flex-1 lg:min-h-0">
          {/* Left Column - Donation and Referral */}
          <div className="lg:col-span-1 flex flex-col gap-3 lg:overflow-y-auto">
            <DonationForm
              userId={user.id}
          ...
          <div className="lg:col-span-3 lg:min-h-0 lg:overflow-y-auto">
